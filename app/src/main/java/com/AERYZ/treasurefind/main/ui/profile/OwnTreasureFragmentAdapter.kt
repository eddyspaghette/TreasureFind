...
class OwnTreasureFragmentAdapter(private val context: Context, private var ownList: ArrayList<String>) :
    RecyclerView.Adapter<OwnTreasureFragmentAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val treasureRef = myFirebase.getTreasureDocument(ownList[position])
        treasureRef
            .get()
    ...
    override fun getItemCount() = ownList.size
